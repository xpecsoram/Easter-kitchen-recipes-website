    ...
    if(isset($_POST['login'])){
    	...
    	if($count == '1'){
    		...
    		if($password == $row['password']){
                ...
                $_SESSION['member'] = true; // save session to check user type
    			$_SESSION['user_id'] = $row['id']; // save logged id in session

    			// redirect to jobs page
    			header('Location:'.ACCOUNT_BASEURL.'/profile.php');
    			exit();
    		}else{
		    	...
		    	<form method="POST" action="" name="login">
                    ...
                    <div class="form-group" style="margin-bottom: 0">
                        <div class="col-sm-8 col-sm-offset-4">
                            ...
                            <p style="margin-bottom: 0">Or <a href="<?php echo ACCOUNT_BASEURL;?>/register.php" class="orange">click here</a> to signup</p>
                        </div>
                    </div>
