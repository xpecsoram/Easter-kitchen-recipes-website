<?php
    ...
    if(isset($_POST['save'])){
		...
		// create sql
		$sql = "UPDATE admin SET name = '$name', username = '$username', date_of_birth = '$date_of_birth', phone = '$phone', gender = '$gender' WHERE id = ".$_SESSION['admin_id'];
		// execute sql
	...
	<div class="row">
		<div class="col-sm-12" style="min-height: 80vh">
		    ...
		    <div class="col-sm-9 well">
		    	...
		    	<?php
		    		// create sql to fetch admin info
	    		...
	    		<form method="POST" action="" name="save">
		    		...
		    		<div class="form-group">
				      	<div class="col-sm-9 col-sm-offset-3">
				        	...
				        	<p><a href="<?php echo ADMIN_BASEURL;?>/change-password.php" class="orange">Click here</a> to change password</p>
				      	</div>
				    </div>
